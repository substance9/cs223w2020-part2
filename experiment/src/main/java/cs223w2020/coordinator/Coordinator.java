...
public class Coordinator {
    public static void main( String[] args ){
        ...
        int maxTxCount = Integer.parseInt(prop.getProperty("count"));
        if (txSimulationPolicy.equals("single")){
            txSimulator = new Thread(new SingleTxSimulator(oQueue, tQueue, maxTxCount)); 
        }
        else if (txSimulationPolicy.equals("batch")){
            txSimulator = new Thread(new BatchTxSimulator(oQueue, tQueue, maxTxCount)); 
        }
        else if (txSimulationPolicy.equals("simplebatch")){
            txSimulator = new Thread(new SimpleBatchTxSimulator(oQueue, tQueue, maxTxCount)); 
        }
        else{
    ...
    private static Properties readConfig( String[] args ){
        ...
        parser.addArgument("-c", "--count").required(true).setDefault("0").help("Maximum number of transaction generated by txsimulator, 0 means indefinite");
        ...
        if (args.length >= 2){
            ...
            prop.setProperty("count", ns.get("count"));
        ...
        System.out.println( "Experiment Parameters:" );
            ...
            System.out.println("--count:\t\t"+prop.getProperty("count"));
